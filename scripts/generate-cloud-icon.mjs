/**
 * Favicon: неонова хмара на прозорому фоні (panel + marketing).
 */
...
<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  ...
  <g transform="translate(56 146) scale(1.35)" filter="url(#glow)">
    <path d="${CLOUD_PATH}" fill="none" stroke="#22d3ee" stroke-width="11" stroke-linecap="round" stroke-linejoin="round" opacity="0.95"/>
    <path d="${CLOUD_PATH}" fill="none" stroke="#e0f7ff" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
</svg>`
